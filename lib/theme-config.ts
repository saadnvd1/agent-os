...
export const DARK_THEMES: ThemeOption[] = [
  {
    ...
    icon: Moon,
    preview: { background: "#0A0A0A", foreground: "#EBEBEB", accent: "#3B82F6" },
  },
  {
    id: "charcoal",
    label: "Charcoal",
    ...
    icon: Moon,
    preview: { background: "#161A1D", foreground: "#E8EAEB", accent: "#5B9BD5" },
  },
  {
    id: "warm",
    label: "Warm",
    ...
    icon: Flame,
    preview: { background: "#1A1612", foreground: "#E8DCC8", accent: "#F59E0B" },
  },
  {
    id: "cool",
    label: "Cool",
    ...
    icon: Zap,
    preview: { background: "#0D1117", foreground: "#E6EDF3", accent: "#58A6FF" },
  },
  {
    id: "gray",
    label: "Gray",
    ...
    icon: Monitor,
    preview: { background: "#191919", foreground: "#DEDEDE", accent: "#2383E2" },
  },
  {
    id: "midnight",
    label: "Midnight",
    ...
    icon: CloudMoon,
    preview: { background: "#0A0E1A", foreground: "#E5E9F0", accent: "#88C0D0" },
  },
  {
    id: "forest",
    label: "Forest",
    ...
    icon: Trees,
    preview: { background: "#0C1410", foreground: "#E8F0ED", accent: "#50C878" },
  },
  {
    id: "purple",
    label: "Purple",
    ...
    icon: Sparkles,
    preview: { background: "#0F0A1A", foreground: "#E8E5F0", accent: "#A855F7" },
  },
  {
    id: "ocean",
    label: "Ocean",
    ...
    icon: Waves,
    preview: { background: "#0A1419", foreground: "#E5EBF0", accent: "#14B8A6" },
  },
  {
    id: "mocha",
    label: "Mocha",
    ...
    icon: Coffee,
    preview: { background: "#1C1612", foreground: "#E6DDD4", accent: "#D4844A" },
  },
];
...
export const LIGHT_THEMES: ThemeOption[] = [
  {
    ...
    icon: Sun,
    preview: { background: "#FFFFFF", foreground: "#111111", accent: "#3B82F6" },
  },
  {
    id: "warm",
    label: "Warm",
    ...
    icon: Flame,
    preview: { background: "#F5F1E8", foreground: "#2D2519", accent: "#D97706" },
  },
  {
    id: "cool",
    label: "Cool",
    ...
    icon: Zap,
    preview: { background: "#F0F4F8", foreground: "#1E293B", accent: "#0EA5E9" },
  },
  {
    id: "soft",
    label: "Soft",
    ...
    icon: CloudMoon,
    preview: { background: "#F8F9FA", foreground: "#212529", accent: "#6366F1" },
  },
  {
    id: "rose",
    label: "Rose",
    ...
    icon: Sparkles,
    preview: { background: "#FAF5F7", foreground: "#2D1A22", accent: "#E74C8C" },
  },
  {
    id: "lavender",
    label: "Lavender",
    ...
    icon: Sparkles,
    preview: { background: "#F7F5FA", foreground: "#1F1A2D", accent: "#9F7AEA" },
  },
  {
    id: "mint",
    label: "Mint",
    ...
    icon: Trees,
    preview: { background: "#F0F9F6", foreground: "#14291F", accent: "#28B88B" },
  },
  {
    id: "peach",
    label: "Peach",
    ...
    icon: Sun,
    preview: { background: "#F9F4F0", foreground: "#2D1F19", accent: "#FA8B6C" },
  },
];
